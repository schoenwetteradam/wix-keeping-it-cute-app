...
export function getWixAuthUrl(state = null, fallbackRedirectUri = null) {
  ...
  // Manually add scope with proper encoding (spaces as %20)
  const baseUrl = `https://www.wix.com/oauth/authorize?${params.toString()}&scope=${encodeURIComponent(scopeString)}`;
